...
const perks = [
  {
    ...
    description:
      "Get your assets delivered toyour email in seconds and download them right away",
  },
  {
    name: "Guaranteed Quality",
    icon: CheckCircle,
    description:
      "Every asset on our platform is verified by our team to ensue our hightest quality standars. Not happy? We offer a 30-day refund guarantee.",
  },
  {
    name: "For the Planet",
    icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Digital Llama. Every asset on our platform is verified by
            our team to enuse orur highest quality standards.{" "}
          </p>
      ...
      <section className="border-t border-gray-200 bg-gray-50 py-10">
        <MaxWidthWrapper className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
          {perks.map((perk) => (
            ...
            >
              <div className="mdZ:flex-shrink-0 flex justify-center">
